  ...
  return (
    <div className="bg-gray-900 h-screen flex">
      <div className="max-w-7xl mx-20 xl:mx-auto my-10">
        <h1 className="text-5xl font-bold text-green-500 flex justify-center mb-10">GALTON BOARD</h1>
        <h2 className="text-xl font-semibold text-green-500 flex justify-start mb-3">Round: Nr. {round}</h2>
        ...
        <div className="grid grid-flow-row grid-cols-10 ml-12 mt-20 gap-14">
